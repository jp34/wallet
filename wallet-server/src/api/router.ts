...
// Patient Endpoints
router.post("/patients", authorize, patients.create);
router.get("/patients", authorize, patients.getMany);
router.get("/patients/:id", authorize, patients.getOne);
router.put("/patients/:id", authorize, patients.update);
router.put("/patients/:id", authorize, patients.delete);

// Patient Medication Endpoints
router.post("/patients/:id/medications", authorize, patientMedications.create);
...
router.put("/patients/:id/medications/:name", authorize, patientMedications.update);
